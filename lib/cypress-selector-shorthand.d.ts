...
type WithinCallbackType<Subject = any, NavigationShorthand extends object = never> = [NavigationShorthand] extends [never]
    ? never
    : (navigationShorthand: ChainableLikeInner<Subject, NavigationShorthand>, currentSubject: Subject) => void;
...
declare module 'cypress-selector-shorthand' {
    export { generateNavigationObject } from 'lib/navigationGenerator';
}
